...
void main() => runApp(MaterialApp(home: UserJobDescription()));

class UserJobDescription extends StatefulWidget {
  final JobDesModel jobDesModel;
  UserJobDescription({Key key, this.jobDesModel}) : super(key: key);

  @override
  _UserJobDescriptionState createState() => _UserJobDescriptionState();
}

class _UserJobDescriptionState extends State<UserJobDescription> {
  // String id_user;
  ...
  Future<Null> deleteFav() async {
    ...
    await Dio().get(url).then((value) => readIdfav());
  }
  ...
  Future<Null> addApplyJob() async {
    String id_resume = resumeModel.id,
        id_jobdescription = jobDesModel.id_jobdescription,
        id_category = jobDesModel.id_category;

    String url =
        '${MyConstant().domain}/parttime/addApplyJob.php?id_resume=$id_resume&id_jobdescription=$id_jobdescription&id_category=$id_category&status=0';
  ...
  Future<Null> checkAddJob() async {
    ...
    String url =
        '${MyConstant().domain}/parttime/checkApplyJob.php?isAdd=true&id_resume=$id_resume&id_jobdescription=$id_jobdescription';
