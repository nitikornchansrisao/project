...
import 'package:parttime/screen/company/apply_company.dart';
...
void main() => runApp(MaterialApp(home: JobDescription()));

class JobDescription extends StatefulWidget {
  final JobDesModel jobDesModel;
  JobDescription({Key key, this.jobDesModel}) : super(key: key);
...
class _JobDescriptionState extends State<JobDescription> {
  ...
  void initState() {
    ...
    // listWidgets.add(EditJob(jobDesModel: jobDesModel));
    findLatLng();
    // findLocationData();
    // readJob();
    readResume();
