...
class StaffCategoryUser extends StatefulWidget {
  @override
  _StaffCategoryState createState() => _StaffCategoryState();
}

class _StaffCategoryState extends State<StaffCategoryUser> {
  ...
  Future<Null> readJob() async {
    String url =
        '${MyConstant().domain}/parttime/Category/getCategory.php?isAdd=true&category=สต๊าฟ';
