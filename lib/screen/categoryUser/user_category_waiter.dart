...
class WaiterCategoryUser extends StatefulWidget {
  @override
  _WaiterCategoryUserState createState() => _WaiterCategoryUserState();
}

class _WaiterCategoryUserState extends State<WaiterCategoryUser> {
  ...
  Future<Null> readJob() async {
    String url =
        '${MyConstant().domain}/parttime/Category/getCategory.php?isAdd=true&category=พนักงานเสิร์ฟ';
