...
class TutorCategoryUser extends StatefulWidget {
  @override
  _TutorCategoryState createState() => _TutorCategoryState();
}

class _TutorCategoryState extends State<TutorCategoryUser> {
  ...
  Future<Null> readJob() async {
    String url =
        '${MyConstant().domain}/parttime/Category/getCategory.php?isAdd=true&category=ติวเตอร์';
