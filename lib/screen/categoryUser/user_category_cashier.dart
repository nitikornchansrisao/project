...
class CashierCategoryUser extends StatefulWidget {
  @override
  _CashierCategoryUserState createState() => _CashierCategoryUserState();
}

class _CashierCategoryUserState extends State<CashierCategoryUser> {
  ...
  Future<Null> readJob() async {
    String url =
        '${MyConstant().domain}/parttime/Category/getCategory.php?isAdd=true&category=พนักงานขาย';
