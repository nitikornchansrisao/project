...
class ChefCategoryUser extends StatefulWidget {
  @override
  _ChefCategoryUserState createState() => _ChefCategoryUserState();
}

class _ChefCategoryUserState extends State<ChefCategoryUser> {
  ...
  Future<Null> readJob() async {
    String url =
        '${MyConstant().domain}/parttime/Category/getCategory.php?isAdd=true&category=ทำอาหาร';
