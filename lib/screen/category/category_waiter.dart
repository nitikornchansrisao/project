...
class WaiterCategory extends StatefulWidget {
  @override
  _WaiterCategoryState createState() => _WaiterCategoryState();
}

class _WaiterCategoryState extends State<WaiterCategory> {
