...
class CashierCategory extends StatefulWidget {
  @override
  _CashierCategoryState createState() => _CashierCategoryState();
}

class _CashierCategoryState extends State<CashierCategory> {
